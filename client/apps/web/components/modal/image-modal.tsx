      ...
      <AnimatePresence mode='wait'>
        {loading ? (
          ...
          <motion.div className='relative mx-auto' {...modal} key={src}>
            <picture className='relative flex max-w-3xl group'>
              ...
              />
              <a
                className='absolute bottom-0 right-0 px-2 py-1 mx-2 mb-2 text-sm transition translate-y-4 rounded-md opacity-0 trim-alt accent-tab bg-main-background/40 text-light-primary/80 hover:bg-main-accent hover:text-white focus-visible:translate-y-0 focus-visible:bg-main-accent focus-visible:text-white focus-visible:opacity-100 group-hover:translate-y-0 group-hover:opacity-100 dark:text-dark-primary/80'
                href={src}
                target='_blank'
                rel='noreferrer'
